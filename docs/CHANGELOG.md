...
* build: `scripts/build-assets.fish` typo for `$fish_lsp_tree_sitter_wasm_path` dest ([8121139](https://github.com/ndonfris/fish-lsp/commit/8121139))
* build(test): stabilize CI execution, hooks, and gitignore ([7871536](https://github.com/ndonfris/fish-lsp/commit/7871536))
* fix: classifier-driven `SyntaxNode` to `FishSymbol` comparision ([550e0d0](https://github.com/ndonfris/fish-lsp/commit/550e0d0))
* fix: hover fallback order, symbol -> prebuilt/snippet -> global -> man -> mutli-ref ([a54428d](https://github.com/ndonfris/fish-lsp/commit/a54428d))
...
* fix(semantic-tokens): `subcommandCache.dispose()` + error logging + related test patch ([7b4f67c](https://github.com/ndonfris/fish-lsp/commit/7b4f67c))
...
* chore: bump docs for 1.1.4-pre.3 ([55974cd](https://github.com/ndonfris/fish-lsp/commit/55974cd))
* chore: bump release `1.1.4` (deps + docs) ([da3d6c2](https://github.com/ndonfris/fish-lsp/commit/da3d6c2))
...
* chore(build): simplify `findFish()` and clear `yarn typecheck` errors ([e905291](https://github.com/ndonfris/fish-lsp/commit/e905291))
* test: consolidate suites, rebuild tree-sitter fast-check & fix mocks/logger ([8fe573b](https://github.com/ndonfris/fish-lsp/commit/8fe573b))
* feat: added `string match -rq -- '(?<var>)' $argv` support to server handlers ([082b90c](https://github.com/ndonfris/fish-lsp/commit/082b90c))
* feat: semantic-tokens, inline-variable, hover, symbol & completion improvements ([aa548ed](https://github.com/ndonfris/fish-lsp/commit/aa548ed)), closes [tree-sitter-fish#41](https://github.com/tree-sitter-fish/issues/41)
...
## <small>1.1.4-pre.3 (2026-06-10)</small>

* fix: hover fallback order, symbol -> prebuilt/snippet -> global -> man -> mutli-ref ([d237641](https://github.com/ndonfris/fish-lsp/commit/d237641))
* fix: classifier-driven `SyntaxNode` to `FishSymbol` comparision ([8ef8df5](https://github.com/ndonfris/fish-lsp/commit/8ef8df5))
* test: consolidate suites, rebuild tree-sitter fast-check & fix mocks/logger ([a78db1f](https://github.com/ndonfris/fish-lsp/commit/a78db1f))
* chore(build): simplify `findFish()` and clear `yarn typecheck` errors ([16f74b2](https://github.com/ndonfris/fish-lsp/commit/16f74b2))
* feat: semantic-tokens, inline-variable, hover, symbol & completion improvements ([653c3e4](https://github.com/ndonfris/fish-lsp/commit/653c3e4))
* docs(snippets): added `dirnext`/`dirprev` variables in `src/snippets/envVariables.json` ([fce53ca](https://github.com/ndonfris/fish-lsp/commit/fce53ca))
...
* fix(v1.1.1-pre.8): polyfills, references, diagnostics, `scripts/*` + lints ([c0694fb](https://github.com/ndonfris/fish-lsp/commit/c0694fb))
* build(scripts/*): moved sourced fish files in build scripts to `scripts/fish/*` ([4c0e418](https://github.com/ndonfris/fish-lsp/commit/4c0e418))
* chore: bump `v1.1.1` ([6a9b917](https://github.com/ndonfris/fish-lsp/commit/6a9b917))
* chore: bump js-yaml in the npm_and_yarn group across 1 directory (#125)ff ([6bfd51f](https://github.com/ndonfris/fish-lsp/commit/6bfd51f)), closes [#125](https://github.com/ndonfris/fish-lsp/issues/125)
* chore: bump vite in the npm_and_yarn group across 1 directory (#117) ([f207d01](https://github.com/ndonfris/fish-lsp/commit/f207d01)), closes [#117](https://github.com/ndonfris/fish-lsp/issues/117)
* feat: Add Semantic Tokens Support (#113) ([399dba7](https://github.com/ndonfris/fish-lsp/commit/399dba7)), closes [#113](https://github.com/ndonfris/fish-lsp/issues/113)
* feat: v1.1.1 nightly (#127) ([25527b0](https://github.com/ndonfris/fish-lsp/commit/25527b0)), closes [#127](https://github.com/ndonfris/fish-lsp/issues/127)
